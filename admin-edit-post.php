...
$tid = intval($_GET['tid']);
$query = "SELECT id,cid,title,content,closecomment,visible,isred,top,fop FROM yunbbs_articles WHERE id='$tid'";
...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if($p_title){
        ...
        $DBS->unbuffered_query("UPDATE yunbbs_articles SET cid='$p_cid',title='$p_title',content='$p_content',closecomment='$p_closecomment',visible='$p_visible',isred='$p_isred',top='$p_top',fop='$p_fop' WHERE id='$tid'");
        if($p_cid != $old_cid){
