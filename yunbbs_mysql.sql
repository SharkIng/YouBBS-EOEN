...
CREATE TABLE yunbbs_articles (
  ...
  isred int(10) unsigned NOT NULL default '0',
  top int(10) unsigned NOT NULL default '0',
  fop int(10) unsigned NOT NULL default '0',
  PRIMARY KEY  (id),
  KEY cid (cid),
...
INSERT INTO yunbbs_categories VALUES(1, '社区指南', 0, '');
...
INSERT INTO yunbbs_links VALUES(null,'EOEN社区', 'https://www.eoen.org/');
...
INSERT INTO yunbbs_settings VALUES('name', 'eoen');
INSERT INTO yunbbs_settings VALUES('site_des', '基于youbbs v1.04搭建');
