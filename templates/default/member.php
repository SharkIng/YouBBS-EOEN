...
<p>会员：<strong>',$m_obj['name'],'</strong> (第',$m_obj['id'],'号会员)';
if($cur_user && $cur_user['flag']>=99){
    echo ' - (',$m_obj['flag'],') <a href="/admin-setuser-',$m_obj['id'],'">编辑</a>';
}
echo '</p><p>主题： ',$m_obj['articles'],'  &nbsp;&nbsp;&nbsp; 回复： ',$m_obj['replies'],'</p>
...
echo '    </a></div>
    <div class="item-content">
        ...
        <span class="item-date"><i class="fa fa-tags"></i> <a href="/nodes/',$article['cid'],'">',$article['cname'],'</a>&nbsp;&nbsp;<i class="fa fa-user"></i> <a href="/user/',$m_obj['id'],'">',$m_obj['name'],'</a>';
if($article['comments']){
    echo '&nbsp;&nbsp;<i class="fa fa-calendar"></i> ',$article['edittime'],'&nbsp;&nbsp;<i class="fa fa-user-secret"></i> 最后回复来自 <a href="/user/',$article['ruid'],'">',$article['rauthor'],'</a>';
}else{
    echo '&nbsp;&nbsp;<i class="fa fa-calendar"></i> ',$article['addtime'];
}
echo '        </span>
    </div>';
if($article['comments']){
