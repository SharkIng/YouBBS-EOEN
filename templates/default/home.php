...
echo '    </a></div>
    <div class="item-content">
        ...
        <span class="item-date"><i class="fa fa-tags"></i> <a href="/nodes/',$article['cid'],'" class="tag">',$article['cname'],'</a>&nbsp;&nbsp;<i class="fa fa-user"></i> <a href="/user/',$article['uid'],'">',$article['author'],'</a>';
if($article['comments']){
