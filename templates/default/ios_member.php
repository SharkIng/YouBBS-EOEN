...
<p>主题： ',$m_obj['articles'],'  &nbsp;&nbsp;&nbsp; 回复： ',$m_obj['replies'],'</p>
...
echo '
<div class="post-list">
    <div class="item-avatar"><a href="/user/',$m_obj['id'],'"><img src="/avatar/normal/',$m_obj['avatar'],'.png" alt="',$m_obj['name'],'" /></a></div>
...
if($article['comments']){
    ...
    echo '&nbsp;&nbsp;<i class="fa fa-user"></i> <a href="/user/',$m_obj['id'],'">',$m_obj['name'],'</a>&nbsp;&nbsp;<i class="fa fa-calendar"></i> ',$article['addtime'],'发表';
}
echo '        </span>
    </div>';
if($article['comments']){
