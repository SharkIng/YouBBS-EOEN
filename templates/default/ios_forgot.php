...
foreach($errors as $error){
    echo '<br/><i class="fa fa-angle-double-right"></i> ',$error,'';
}
echo '</p>
...
<p><input type="submit" value=" 取回密码 " name="submit" class="textbtn" style="margin-left:60px;" /> </p>';
if($url_path == 'login'){
...
echo '	<div class="title"><i class="fa fa-info-circle"></i> 密码找回</div>
