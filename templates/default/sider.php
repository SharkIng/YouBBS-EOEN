...
<div class="sider-box">
	...
	<div class="user">
		<table cellpadding="0" cellspacing="0" border="0" width="100%">
			<tbody>
				<tr>
					<td width="73" valign="top"><img src="/avatar/large/',$cur_user['avatar'],'.png" class="avatar" border="0" align="default" style="max-width: 73px; max-height: 73px;border-radius: 8px;"></td>
					<td width="10" valign="top"></td>
					<td width="auto" align="left"><span class="bigger"><a href="/user/',$cur_user['id'],'" style="color:#444;text-decoration: none;font-size: 23px;">',$cur_user['name'],'</a></span><br/><br/><a href="/newpost/',$cid,'" rel="nofollow"><i class="fa fa-pencil-square-o" style="font-size: 25px;color: #444;"><span style="font-size: 13px; font-weight: bold;">创作新主题</span></i></a></td>
				</tr>
			</tbody>
		...
		if($cur_user['flag'] == 5){
        echo'<a href="/user/',$cur_user['id'],'" class="leftnotic"><i class="fa fa-user"></i> 普通用户</a>';
		}else{
		if($cur_user['flag'] == 99){
        echo'<a href="/user/',$cur_user['id'],'" class="leftnotic"><i class="fa fa-user-secret"></i> 社区助手</a>';
			}
		}
echo'</div>
	</div>
...
echo '
<div class="sider-box">
    <div class="sider-box-title"><i class="fa fa-angle-double-right"></i> 最热节点</div>
    <div class="sider-box-content">
    <div class="btn">';
...
echo '
<div class="sider-box">
    <div class="sider-box-title"><i class="fa fa-angle-double-right"></i> 社区节点</div>
    <div class="sider-box-content">
    <div class="btn">';
...
echo '
<div class="sider-box">
    <div class="sider-box-title"><i class="fa fa-angle-double-right"></i> 链接</div>
    <div class="sider-box-content">
    <div class="btn">';
